 ...
 */
function create_block_mitlib_block_featured_collection_section_block_init() {
	wp_register_block_types_from_metadata_collection( __DIR__ . '/build', __DIR__ . '/build/blocks-manifest.php' );
}
add_action( 'init', 'create_block_mitlib_block_featured_collection_section_block_init' );
