			...
			<div className="content-wrapper">
				...
				<ol className="hours-list">
					...
					<li className="hour-rotch">
						<span className="library-name">
							<a className="link-no-underline" href="/rotch">
								Rotch Library
							</a>
						</span>
						<span className="library-hours">
							<span data-location-hours="Rotch Library"></span>
						</span>
						<span className="library-study">
							<i
								className="fa-light fa-moon"
					...
					<li className="hour-barker">
						<span className="library-name">
							<a className="link-no-underline" href="/barker">
								Barker Library
							</a>
						</span>
						<span className="library-hours">
							<span data-location-hours="Barker Library"></span>
						</span>
						<span className="library-study">
							<i
								className="fa-light fa-moon"
					...
					<li className="hour-lewis">
						<span className="library-name">
							<a className="link-no-underline" href="/music">
								Lewis Music Library
							</a>
						</span>
						<span className="library-hours">
							<span data-location-hours="Lewis Music Library"></span>
						</span>
						<span className="library-study"></span>
					</li>
				</ol>
				<a href={ linkUrl } className="link-on-dark">
					{ linkText }
				</a>
			</div>
		</section>
