<?php
/**
 * The template used for displaying a feed of posts below the usual page
 * content.
 *
 * Please note: The div#sticky-posts-2 in this template appears to have been
 * copied from the output generated by the Ultimate Posts Widget plugin. This
 * is potentially quite a lot of technical debt. It is a prime candidate for
 * re-implementation if this feature (a page template that displays a "recent
 * news" style list of posts) is worth keeping.
 *
